...
<head>
	<!-- Basic Page Needs -->
        <meta charset="utf-8">
        <title>HolyAni.me</title>
        <meta name="description" content="Watch the latest Anime in HD/HQ for Free">
        <meta name="keywords" content="Anime, HD, Free, KissAnime, watch, japanese, english, subbed, sub, dub">
        <meta name="author" content="HolyAni.me">
...
Start doing.'>
        ...
        <section class="container">
            <div class="movie-best">
                 <div class="col-sm-10 col-sm-offset-1 movie-best__rating"> Popular Today </div>
                 <div class="col-sm-12 change--col">
                    ...
                    $html = file_get_html('http://www.masterani.me/');

                    $ClassList = array("test");
                    // Find the popular today.

                    $collection = $html->find('.anime-circle-list');
                    foreach($collection[1]->find('img') as $covers)
                        array_push($ClassList, $covers->src);

                    // Null but DO NOT remove.
                    $ArrayList = array("test");
                    // Description of each Anime
                    $ArrayInfo = array("test");
                    // Title of each Anime
                    $ArrayTitle = array("test");
                    // Rating of each Anime
                    $ArrayRating = array('test');
                    // Type of Anime
                    $ArrayType = array('test');
                    // # of Episodes
                    $ArrayEpisodes = array('test');
                    // Status of the Anime
                    $ArrayStatus = array('test');
                    // Gets Airing info for Anime
                    $ArrayAiring = array('test');
                    // AGE RATING
                    $ArrayAge = array('test');

                    foreach($collection[1]->find('a') as $element) {
                        //Gets anime link for the media source
                        array_push($ArrayList, $element->href);
                        //Get All Anime name in order.
                        $property = 'data-content';
                        $string = str_replace(' ', '-', $element->$property);
                        array_push($ArrayTitle, strtolower($string));
                    }
                    // Gets all the information for the current Anime.
                    $i = 1;
                    while($i<8){
                        $info_html = file_get_html('http://www.masterani.me/' . $ArrayList[$i] . '/');
                        $description = $info_html->find('meta');
                        //Get the Anime Description
                        if(isset($description[18])){
                            array_push($ArrayInfo, $description[18]->content);
                        }
                        $z = 0;
                        foreach($info_html->find('div.info p') as $library) {
                            ...
                            elseif ($z == 1) {
                                array_push($ArrayType, $rating);
                                $z = $z + 1;
                            }
                            elseif ($z == 2) {
                                array_push($ArrayEpisodes, $rating);
                                $z = $z + 1;
                            }
                            elseif ($z == 3) {
                                array_push($ArrayStatus, $rating);
                                $z = $z + 1;
                            }
                            elseif ($z == 4) {
                                array_push($ArrayAiring, $rating);
                                $z = $z + 1;
                            }
                            elseif ($z == 5) {
                                array_push($ArrayAge, $rating);
                                $z = $z + 1;
                            }
                        }
                    ...
                    ?>
                     ...
                     <div class="movie-beta__item ">
                        ...
                        echo '<img  src=' . $ClassList[1] . 'height="300" width="190">';
                        echo "<span class='best-rate'>" . substr($ArrayRating[1], 0, 3) . "</span>";

                        ?>
                         <ul class="movie-beta__info">
                             <?php
                             echo "<li><span class='best-voted'>" . mt_rand(987, 1354) . " people voted today</span></li>";
                             ?>
                             <li>
                                 <?php
                                echo "<p class='movie__time'>" . $ArrayType[1] . " - " . $ArrayEpisodes[1] . ' episodes' . "</p>";
                                 ?>
                                <?php

                                echo '<p>' . $ArrayInfo[1]  . '</p>';
                                ?>
                                <p>Adventure | Drama | SHIT </p>
                                 <?php
                                echo '<p>' . $ArrayStatus[1] . ' - ' . $ArrayAge[1] .  "</p>";
                                 ?>
                             </li>
                             <li class="last-block">
                     ...
                     <div class="movie-beta__item second--item">
                         <?php
                         echo '<img  src=' . $ClassList[2] . 'height="300" width="190">';
                         echo "<span class='best-rate'>" . substr($ArrayRating[2], 0, 3) . "</span>";
                         ?>
                         <ul class="movie-beta__info">
                             <?php

                             echo "<li><span class='best-voted'>" . mt_rand(678, 987) . " people voted today</span></li>";
                             ?>
                             <li>
                                 <?php
                                 echo "<p class='movie__time'>" . $ArrayType[2] . " - " . $ArrayEpisodes[2] . ' episodes' . "</p>";
                                 ?>
                                 <?php

                                 echo '<p>' . $ArrayInfo[2]  . '</p>';
                                 ?>
                                 <p>Adventure | Drama | SHIT </p>
                                 <?php

                                 echo '<p>' . $ArrayStatus[2] . ' - ' . $ArrayAge[2] . "</p>";
                                 ?>
                             </li>
                             <li class="last-block">
                                 <a href="#" class="slide__link">more</a>
                     ...
                     <div class="movie-beta__item third--item">
                         <?php
                         echo '<img  src=' . $ClassList[3] . 'height="300" width="190">';
                         echo "<span class='best-rate'>" . substr($ArrayRating[3], 0, 3) . "</span>";
                         ?>
                         <ul class="movie-beta__info">
                             <?php
                             echo "<li><span class='best-voted'>" . mt_rand(568, 678) . " people voted today</span></li>";
                             ?>
                             <li>
                                 <?php
                                 echo "<p class='movie__time'>" . $ArrayType[3] . " - " . $ArrayEpisodes[3] . ' episodes' . "</p>";
                                 ?>
                                 <?php

                                 echo '<p>' . $ArrayInfo[3]  . '</p>';
                                 ?>
                                 <p>Adventure | Drama | SHIT </p>
                                 <?php
                                 echo '<p>' . $ArrayStatus[3] . ' - ' . $ArrayAge[3] . "</p>";
                                 ?>
                             </li>
                             <li class="last-block">
                                 <a href="#" class="slide__link">more</a>
                     ...
                     <div class="movie-beta__item hidden-xs">
                         <?php
                         echo '<img  src=' . $ClassList[4] . 'height="300" width="190">';
                         echo "<span class='best-rate'>" . substr($ArrayRating[4], 0, 3) . "</span>";
                         ?>

                         <ul class="movie-beta__info">
                             <?php
                             echo "<li><span class='best-voted'>" . mt_rand(465, 568) . " people voted today</span></li>";
                             ?>
                             <li>
                                 <?php
                                 echo "<p class='movie__time'>" . $ArrayType[4] . " - " . $ArrayEpisodes[4] . ' episodes' . "</p>";
                                 ?>
                                 <?php

                                 echo '<p>' . $ArrayInfo[4]  . '</p>';
                                 ?>
                                 <p>Adventure | Drama | SHIT </p>
                                 <?php
                                 echo '<p>' . $ArrayStatus[4] . ' - ' . $ArrayAge[4] . "</p>";
                                 ?>
                             </li>
                             <li class="last-block">
                                 <a href="#" class="slide__link">more</a>
                     ...
                     <div class="movie-beta__item hidden-xs hidden-sm">
                         <?php
                         echo '<img  src=' . $ClassList[5] . 'height="300" width="190">';
                         echo "<span class='best-rate'>" . substr($ArrayRating[5], 0, 3) . "</span>";
                         ?>
                         <ul class="movie-beta__info">
                             <?php
                             echo "<li><span class='best-voted'>" . mt_rand(265, 465) . " people voted today</span></li>";
                             ?>
                             <li>
                                 <?php
                                 echo "<p class='movie__time'>" . $ArrayType[5] . " - " . $ArrayEpisodes[5] . ' episodes' . "</p>";
                                 ?>
                                 <?php

                                 echo '<p>' . $ArrayInfo[5]  . '</p>';
                                 ?>
                                 <p>Adventure | Drama | SHIT </p>
                                 <?php
                                 echo '<p>' . $ArrayStatus[5] . ' - ' . $ArrayAge[5] . "</p>";
                                 ?>
                             </li>
                             <li class="last-block">
                                 <a href="#" class="slide__link">more</a>
                     ...
                     <div class="movie-beta__item hidden-xs hidden-sm">
                         <?php
                         echo '<img  src=' . $ClassList[6] . 'height="300" width="190">';
                         ?>
                         <?php
                         echo "<span class='best-rate'>" . substr($ArrayRating[6], 0, 3) . "</span>";
                         ?>

                         <ul class="movie-beta__info">
                             <?php
                             echo "<li><span class='best-voted'>" . mt_rand(98, 265) . " people voted today</span></li>";
                             ?>
                             <li>
                                 <?php
                                 echo "<p class='movie__time'>" . $ArrayType[6] . " - " . $ArrayEpisodes[6] . ' episodes' . "</p>";
                                 ?>
                                 <?php

                                 echo '<p>' . $ArrayInfo[6]  . '</p>';
                                 ?>
                                 <p>Adventure | Drama | SHIT </p>
                                 <?php
                                 echo '<p>' . $ArrayStatus[6] . ' - ' . $ArrayAge[6] . "</p>";
                                 ?>
                             </li>
                             <li class="last-block">
                                 <a href="#" class="slide__link">more</a>
                ...
                <div class="col-sm-10 col-sm-offset-1 movie-best__check">Check All Anime Being Watched</div>
            </div>
                ...
                <div class="mega-select-present mega-select-top mega-select--full">
                    <div class="mega-select-marker">
                        <div class="marker-indecator location">
                            <p class="select-marker"><span>Search over 10k+ Anime</span> <br>For Free!</p>
                        </div>
            ...
            <h2 id='target' class="page-heading heading--outcontainer">Recently Added Anime</h2>
